# ============================================================
# 📊 CUSTOMER INTELLIGENCE DASHBOARD — GOOGLE COLAB
# ============================================================
# Copy toàn bộ file này vào MỘT cell duy nhất trong Colab.
# Chạy → đợi ~30s → click link localtunnel → nhập IP.
#
# Nguồn: NBFO Target List · CX Persona Segments · Alert List Security
# ============================================================
...
# ---- 2) TẠO FILE app.py (dùng Python write, KHÔNG dùng %%writefile) ----
app_code = r'''
...
# ---- 3) TẠO THEME & CHẠY STREAMLIT NGẦM ----
import os
...
try:
    ...
    print("⚠️ Streamlit might still be starting...")

# ---- 4) LẤY IP VÀ TẠO PUBLIC URL ----
...
print(f"\n  🌐 Your Colab IP: {ip}")
print("\n  📌 Cach mo dashboard:")
print("  1. Click link localtunnel ben duoi")
print("  2. Nhap IP ben tren neu duoc yeu cau")
print("  3. Dashboard se hien thi trong trinh duyet")
print("\n" + "=" * 65 + "\n")

# Chạy localtunnel
!npx localtunnel --port 8501

print("\n⚠️ Neu link khong xuat hien, hay chay lai cell sau 10s.")
